               ...
               foreach ($apartCliente as $apart):
                  ...
                  if ($resta > 0){
                     ...
                     if ($abonoProd > 0){
                        ...
                        $insResult = altaVenta($id,$productId,'0',$abonoProd,$fecha_actual,$usuario,$sucursal,$a_vendedor,$cliente,'0',$a_tipoPago,$id_ticket,$idCredito,$montoPorcVenta,$montoPorcCompra,'0');
