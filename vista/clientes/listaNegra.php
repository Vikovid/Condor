<?php
  $page_title = 'Clientes en lista negra';
...
<body onload="foco();">
   <form name="form1" method="post" action="listaNegra.php">
      <br>
<div class="row">
   <div class="col-md-12">
         ...
         <div class="panel-heading clearfix">
            <div class="pull-right">
               <div class="form-group">
                  ...
                  <a href="#" onclick="listaNegra();" class="btn btn-primary">Buscar</a> 
                  <div class="pull-right">
                     <strong>
