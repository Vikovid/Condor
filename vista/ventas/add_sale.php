...
<script language="Javascript">
   function presupuesto(){
      ...
      if (cont > 0) {
         document.form1.action = "presupuesto.php";
         document.form1.submit();
      } else {
         alert("Debe agregar productos para generar el presupuesto");
         return -1;
      }
   }
</script>
            ...
            <div class="form-group">
               <table width="100%" align="center">       
                  <tr>
                     ...
                     <?php if($nivel != "5"){ ?>
                        <td><a href="#" onclick="presupuesto();" class="btn btn-primary">Presupuesto</a></td>
                     <?php } ?>
            ...
            <div class="form-group">
               <table HEIGHT="70px" id="tab" align="right">
                  <tr>
                     ...
                     <td width="70%" style="font-size:40px" align="right"><?php echo money_format('%.2n',$total); ?></td>
                  </tr>
               </table>
            </div>   
         </div>
