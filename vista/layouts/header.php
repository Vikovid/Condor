...
<!DOCTYPE html>
  ...
  ?> 
    <header id="header">
      <div class="logo pull-left"> Cóndor - Inventario </div>
            ...
            <ul class="info-menu list-inline list-unstyled">
               <li class="profile">
                  <a href="#" data-toggle="dropdown" class="toggle" aria-expanded="false">
                     <img src="../../libs/imagenes/usuarios/<?php echo $user['image'];?>" alt="user-image" class="img-circle img-inline">
    ...
    <div class="sidebar">
       ...
       <?php elseif($user['user_level'] === '5'): ?>
         <!-- Linea menu -->
       <?php include_once('linea_menu.php');?>
