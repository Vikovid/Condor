...
if ($consCliente != null){
   ...
   $nivel = $consCliente['user_level'];
}

$productos = buscaProductosTicket($idTicket);

if ($nivel == "4")
   $consPagos = buscaPagosSucursal($idTicket,"0");
else
...
if ($bandIva == "1"){
   ...
   $pdf->Cell(40,18,money_format('%.2n',$iva),1,1,'R',1);
   $pdf->Cell(160,18,'Total',1,0,'C',1);
   $pdf->Cell(40,18,money_format('%.2n',$totIva),1,1,'R',1);
}
