...
function listaBlanca(){
  document.form1.action = "listaBlanca.php";
  document.form1.submit();
}

function listaNegra(){
  document.form1.action = "listaNegra.php";
  document.form1.submit();
}

function listaAnt(){
   document.form1.lista.value=document.form1.listaAux.value;
}
